...
<style type="text/css">
	...
	#wordtext{
	display:inline-block;padding:6px 12px;font-size:12px;font-weight:300;line-height:1.4;color:#221919;background:#fff;border:1px solid #a4a2a2;resize:none;
		...
		<div style="margin:20px 0 10px 0;"></div>
		    <div id="content" class="easyui-panel"  style="width:711px;height:620px;" 
				...
				<header>
					<div class="m-toolbar">
						<div class="m-left" style="margin-left: 60px;">
							<a href="<%=path %>/fankui/all" class="easyui-linkbutton m-back" data-options="plain:true,outline:true,back:true">返回列表</a>
						</div>
				...
				<div style="padding:10px;margin-left: 50px;margin-top: 50px;">
					...
					<h3>反馈编号:</h3><div class="textS"><s:property value="fankui.TBackid"/></div><br/><br/>
					<h3>反馈标题:</h3><div class="textS"><s:property value="fankui.title"/></div><br/><br/>
					<h3>反馈问题:</h3><div class="textS"><s:property value="fankui.pro"/></div><br/><br/>
					<h3>反馈答案:</h3><div class="textS"><s:property value="fankui.key"/></div><br/><br/>
					<h3>反馈时间:</h3><div class="textS"><s:property value="fankui.time"/></div>
				</div>
				<div style="margin-right: 100px; float:right;">
					<a href="javascript:;" onclick="addPro();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" style="height:32px;">反馈回复</a>
				</div>
		</div>
	</div>
	<div id="addWin" class="easyui-window" title="反馈回复"  data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width: 400px; height: 300px; padding: 5px;">
			<form id="addForm">
				...
				<div style="margin-left: 170px;float: left;">
					<a href="javascript:;" onclick="closeAdd();" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" style="height:32px;float: left;">取消提交</a>
				</div>
				<div style="margin-left: 20px;float: left;">
					<a href="javascript:;" onclick="doAdd();" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="height:32px;">提交问题</a>
				</div>
			</form>
		</div>
