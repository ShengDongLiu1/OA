...
<body>
	    ...
	    <div id="content" class="easyui-panel" title="发布公告" style="width:730px;height:491px;" 
			...
			<div id="tb" style="padding:5px;">
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="addPro();">添加公告</a>
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" onclick="removeCP();">删除公告</a>
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="edit();">修改公告信息</a>
			</div>
			
			<div id="addWin" class="easyui-window" title="添加公告"  data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width: 400px; height: 400px; padding: 5px;">
				<form id="addForm" enctype="multipart/form-data">
					...
					<div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
						<div>公告开始时间:</div><br/>
						<input class="easyui-datetimebox" data-options="required:true" name="msg.msgks" id="msgks" style="width:300px;height:25px">
					</div>
					<div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
						<div>公告有效期至:</div><br/>
						<input class="easyui-datetimebox" data-options="required:true"  name="msg.msgjz" style="width:300px;height:25px">
					</div>
			...
			<div id="editWin" class="easyui-window" title="修改班级信息"  data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width: 400px; height: 450px; padding: 5px;">
				<form id="editForm" enctype="multipart/form-data">
					...
					<div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
						<div>公告开始时间:</div><br/>
						<input class="easyui-datetimebox" data-options="required:true" name="msg.msgks" id="xgmsgks" style="width:300px;height:25px">
					</div>
					<div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
						<div>公告有效期至:</div><br/>
						<input class="easyui-datetimebox" data-options="required:true"  name="msg.msgjz" id="xgmsgjz" style="width:300px;height:25px">
					</div>
					<div style="margin-left: 170px;float: left;">
