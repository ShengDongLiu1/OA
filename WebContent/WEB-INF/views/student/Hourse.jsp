		...
		<div style="padding:10px 60px 20px 60px">
			<form id="ff" method="post">
			  	<table cellpadding="5">
					<tr>
			  			<td>宿舍名称:</td>
			  			<td><input class="easyui-textbox" id="hourname" data-options="required:true" /></input></td>
			  		</tr>
				</table>
		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				...
				<tr>
					<td>宿舍名称</td>
					<td>
						<input class="easyui-validatebox textbox" name="hourname" id="hname" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
