    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table cellpadding="5">
                <tr>
                    <td>Name:</td>
                    <td><input class="easyui-textbox" id="name" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>NickName:</td>
                    <td><input class="easyui-textbox" id="nickname" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>Gender:</td>
                    <td><input class="easyui-textbox" id="gender" data-options="required:true"/></td>
                </tr>
            </table>
        ...
        <form id="editForm">
            <table>
                ...
                <tr>
                    <td>姓名</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="name" id="editName"
                ...
                <tr>
                    <td>昵称</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="nickname" id="editNickname"
                               data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>性别</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="gender" id="editGender"
                               data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
            </table>
