...
<style type="text/css">
	...
	#classnamets{text-align:right;font-size:14px;color:#5e5e5e;margin:10px 0 0 0;margin-right: 50px;}
	#wordage{text-align:right;font-size:14px;color:#5e5e5e;margin:10px 0 0 0;margin-right: 50px;}
	#xgclassnamets{text-align:right;font-size:14px;color:#5e5e5e;margin:10px 0 0 0;margin-right: 50px;}
	#xgwordage{text-align:right;font-size:14px;color:#5e5e5e;margin:10px 0 0 0;margin-right: 50px;}
</style>
	...
	<div class="easyui-navpanel">
	    ...
	    <div id="content" class="easyui-panel" title="班级管理" style="width:930px;height:491px;" 
			...
			<div id="tb" style="padding:5px;">
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="addPro();">添加班级</a>
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" onclick="removeCP();">删除班级</a>
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="edit();">修改班级信息</a>
				<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="addLook();">选择查看班级详情</a>
			</div>
			
			<div id="addWin" class="easyui-window" title="添加班级"  data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width: 400px; height: 450px; padding: 5px;">
				<form id="addForm" enctype="multipart/form-data">
					...
					<div style="margin-bottom:20px;margin-left: 40px;">
						任课老师：<input id="rkls" class="easyui-combobox" data-options="required:true" name="classes.empteach.eid" /><br/><br/>
						辅导老师：<input id="fdls" class="easyui-combobox" data-options="required:true" name="classes.empteachs.eid" /><br/><br/>
						&nbsp;班主任：<input id="bzr" class="easyui-combobox" data-options="required:true" name="classes.empteaches.eid" />
					</div>
					<div style="margin-bottom: 20px;margin-left: 40px;">
						<div>班级地址:</div><br/>
					...
					<div style="margin-left: 170px;float: left;">
						<a href="javascript:;" onclick="closeAdd();" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" style="height:32px;float: left;">取消添加</a>
					</div>
					<div style="margin-left: 20px;float: left;">
						<a href="javascript:;" onclick="doAdd();" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="height:32px;">确认添加</a>
					</div>
				</form>
			</div>
			
			<div id="editWin" class="easyui-window" title="修改班级信息"  data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width: 400px; height: 450px; padding: 5px;">
				<form id="editForm" enctype="multipart/form-data">
					...
					<div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
						<div>班级名称:</div><br/>
						<input class="easyui-textarea" id="xgclassname" name="classes.classname" style="width:300px;height:25px">
