    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                <tr>
                    <td>课程:</td>
                    <td><input class="easyui-combobox" id="objectid" name="cplan.course.objectid"
                               data-options="required:true"></td>
                </tr>

                <tr>
                    <td>讲课内容:</td>
                    <td><input class="easyui-textbox" id="content" name="cplan.content" data-options="required:true">
                    </td>
                </tr>
            </table>
        ...
        <form id="editForm">
            <table>
                <tr>
                    <td>编号:</td>
                    <td>
                        <input class="easyui-textbox" id="ki" name="cplan.kid" data-options="required:true" readonly>
                    </td>
                </tr>
                <tr>
                    <td>课程:</td>
                    <td><input class="easyui-combobox" id="ob" name="cplan.course.objectid"
                               data-options="required:true"></td>
                </tr>

                <tr>
                    <td>讲课内容:</td>
                    <td><input class="easyui-textbox" id="co" name="cplan.content" data-options="required:true"></td>
                </tr>
            </table>
            <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
