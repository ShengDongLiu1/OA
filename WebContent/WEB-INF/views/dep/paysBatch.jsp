...
<div>
    <div>
        <div style="float: left;margin-top: 20px;margin-left: 30px;"><a href="<%=path %>/pays/all"
                                                                        class="easyui-linkbutton m-back"
                                                                        data-options="plain:true,outline:true,back:true">返回工资列表</a>
        </div>
