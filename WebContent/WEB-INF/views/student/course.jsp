		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				<tr>
					<td>编号:</td>
					<td>
						<input class="easyui-textbox" id="oid" name="objectid" data-options="required:true" readonly ></input>
					</td>
				</tr>
		  		<tr>
		  			<td>课程:</td>
		  			<td><input class="easyui-textbox" id="oname" name="objectname" data-options="required:true" ></input></td>
		  		</tr>
		  		<tr>
		  			<td>学期:</td>
		  			<td><input class="easyui-textbox" id="ster" name="semester" data-options="required:true" ></input></td>
		  		</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
	...
	<script type="text/javascript">
		...
		function edit(){
			...
			if($("#editForm").form("validate")){
				...
				$.get('course/update',{'course.objectid':objectid,'course.objectname':objectname,'course.semester':semester},"JSON");
				$("#editForm").form("clear");
