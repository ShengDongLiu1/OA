...
<head>
    ...
    <link title="style2" rel="alternate stylesheet" href="<%=path %>/css/login_stu_css/style2.css" type="text/css"/>
    <link title="style3" rel="alternate stylesheet" href="<%=path %>/css/login_stu_css/style3.css" type="text/css"/>
</head>
<body onload="init()">
