...
<body>
			...
			<form id="ff" enctype="multipart/form-data">
			  	<table>
			  		<tr>
				  		<td>员工姓名</td>
						<td>
							<input class="easyui-combobox" data-options="required:true" name="pays.dep.eid" id="add_pempid" />
						</td>
					</tr>
			  		<tr>
			  			<td>奖励金额:</td>
			  			<td><input class="easyui-textbox" name="pays.paysa" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>惩罚金额:</td>
			  			<td><input class="easyui-textbox" name="pays.paysb" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>奖罚原因:</td>
			  			<td><input class="easyui-textbox" name="pays.payspro" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>基本工资:</td>
			  			<td><input class="easyui-textbox" name="pays.payssta" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>补贴工资:</td>
			  			<td><input class="easyui-textbox" name="pays.paysc" data-options="required:true" /></input></td>
			  		</tr>
				</table>
				<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
					...
					<a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="editClose();" style="width:80px">取消</a>
				</div>
			</form>
		</div>
	</div>
	...
	<div style="margin:20px 0;"></div>
	<div id="choiceWindow" class="easyui-window" title="批量选择员工" data-options="closed:true,iconCls:'icon-add'" style="padding:10px;">
			<form id="choice" enctype="multipart/form-data">
				<table id="dg" class="easyui-datagrid"  data-options="toolbar:'#pl',rownumbers:true" style="width:300px;height:200px">
					<thead></thead>
				</table>
			</form>
	</div>
	<div style="padding:10px;">
		<a href="javascript:;" class="easyui-linkbutton" id="pl" data-options="iconCls:'icon-help'" onclick="addPl();">添加员工</a><br/><br/>
	</div>
