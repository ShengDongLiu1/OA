    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                ...
                <tr>
                    <td>学生编码:</td>
                    <td><input class="easyui-combobox" id="sstuid" name="items.student.intenid"
                               data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>答辩时间:</td>
                    <td><input class="easyui-datetimebox" id="sdate" name="items.sdate" data-options="required:true"/>
                    </td>
                </tr>
                <tr>
                    <td>答辩成绩:</td>
        ...
        <form id="editForm">
            <table>
                ...
                <tr>
                    <td>项目:</td>
                    <td>
                        <input class="easyui-textbox" name="items.sname" id="sn" data-options="required:true"/>
                        <!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>学生:</td>
                    <td><input class="easyui-combobox" id="si" name="items.student.intenid"
                               data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>答辩时间:</td>
                    <td>
                        <input class="easyui-datetimebox" name="items.sdate" id="sd" data-options="required:true"/>
                        <!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>成绩:</td>
                    <td>
                        <input class="easyui-textbox" name="items.score" id="sc" data-options="required:true"/>
                        <!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
            </table>
