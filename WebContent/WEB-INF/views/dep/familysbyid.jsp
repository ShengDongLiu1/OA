...
<script type="text/javascript">
	...
	function edit() {
		...
		if (row) {
			...
			$('#updatedep').combobox('setValue',row.dep.ename);//让他默认选中当前要修改的员工姓名
		...
		<form id="editForm" enctype="multipart/form-data" >
			<table >
				<tr>
		  			<td>选择员工:</td>
		  			<td><br/>
		  			<input id="updatedep" class="easyui-combobox" data-options="required:true"  name="family.eid" /><br/><br/>
		  			</td>
		  		</tr>
				<tr height="35px;">
					<td>姓名:</td>
			...
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
				...
				<a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="" style="width:80px; height: 20px;">取消</a>
			</div>
		</form>
	</div>
		...
		<form id="addForm" enctype="multipart/form-data">
			<table>
				<tr>
		  			<td>选择员工:</td>
		  			<td><br/>
		  			<input id="adddep" class="easyui-combobox" data-options="required:true"  name="family.eid" /><br/><br/>
		  			</td>
		  		</tr>
				<tr height="35px;">
					<td>姓名:</td>
