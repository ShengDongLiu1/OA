	...
	<div id="editWin" class="easyui-window" title="修改部门"
		...
		<form id="editForm" enctype="multipart/form-data">
			...
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
				...
				<a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="closeupdate();" style="width:80px; height: 20px;">取消</a>
			</div>
		</form>
	</div>
	...
	<div id="addWin" class="easyui-window" title="添加部门"
		...
		<form id="addForm" enctype="multipart/form-data">
			...
			<div data-options="region:'south',border:false" style="text-align:right;padding:10px 0 0;">
					...
					<a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="Winclose('addWin')" style="width:80px;height:20px;">取消</a>
			</div>
		</form>
	</div>
