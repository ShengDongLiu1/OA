		...
		<div style="padding:10px 60px 20px 60px">
			<form id="ff" method="post">
			  	<table>
			  		...
			  		<tr>
			  			<td>学生编码:</td>
			  			<td><input class="easyui-textbox" id="sstuid" name="items.sstuid" data-options="required:true" ></input></td>
			  		</tr>
			  		<tr>
			  			<td>指导老师:</td>
			  			<td><input class="easyui-textbox" id="steacher" name="items.steacher" data-options="required:true" ></input></td>
			  		</tr>
			  		
			  		<tr>
			  			<td>答辩时间:</td>
			  			<td><input class="easyui-textbox" id="sdate" name="items.sdate" data-options="required:true" ></input></td>
			  		</tr>
			  		<tr>
			  			<td>答辩成绩:</td>
		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				...
				<tr>
					<td>项目名称</td>
					<td>
						<input class="easyui-textbox" name="sname" id="sname" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>学生编码</td>
					<td>
						<input class="easyui-textbox" name="sstuid" id="sstuid" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>指导老师</td>
					<td>
						<input class="easyui-textbox" name="steacher" id="steacher"  data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>答辩时间</td>
					<td>
						<input class="easyui-textbox" name="sdate" id="sdate" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>答辩成绩</td>
					<td>
						<input class="easyui-textbox" name="score" id="score"  data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
	...
	<script type="text/javascript">
		...
		function edit(){
			...
			if($("#editForm").form("validate")){
				...
				var sdate = $("#sdate").val();
				var score = $("#score").val();
				$.get('items/update',{'items.xid':xid,'items.sname':sname,'items.sstuid':sstuid,'items.steacher':steacher,'items.sdate':sdate,'items.score':score},"JSON");
				$("#editForm").form("clear");
