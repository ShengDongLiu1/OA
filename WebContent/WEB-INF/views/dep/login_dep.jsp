...
<body onload="init()">
    ...
    <fieldset>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" id="field1" name="dep.ename" class="required" title="填写您的姓名" /></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget">
                <select id="year"></select>年 <select id="month" onchange="changeDay()"></select>月<select id="day"></select>日
            </div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">电话号码</label>:</div>
            <div class="field-widget"><input type="text" id="field3" name="dep.enumber" class="required" title="输入二代身份证" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">身份证号</label>:</div>
            <div class="field-widget"><input type="text" id="field3" name="dep.ecertid" class="required" title="输入二代身份证" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field4">员工籍贯</label>:</div>
            <div class="field-widget"><input type="text" id="field4" name="dep.ecity" class="required" title="填写您的籍贯" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field5">民族</label>:</div>
            <div class="field-widget"><input type="text" id="field5" name="dep.eanton" class="required" title="填写您的种族" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field7">家庭住址</label>:</div>
            <div class="field-widget"><input type="text" name="dep.eaddr" id="field7" class="required" title="填写您的住址" /></div>
        </div>
        	 ...
        	 <fieldset>
        	 	<legend>工作经历</legend>
	            	 <div class="form-row">
			            ...
			            <div class="field-widget"><input type="text" id="field4" name="jobs.jstart" class="required" title="填写公司名称" /></div>
			        </div>
			        <div class="form-row">
			            <div class="field-label"><label for="field5">公司职位</label>:</div>
			            <div class="field-widget"><input type="text" id="field5" name="jobs.jedu" class="required" title="填写公司职位" /></div>
			        </div>
			        
			        <div class="form-row">
			            <div class="field-label"><label for="field7">开始时间</label>:</div>
			            <div class="field-widget"><input class="easyui-datetimebox"  type="text" name="jobs.jend" id="field7" class="required" title="填写开始时间" /></div>
			        </div>
			        <div class="form-row">
			            <div class="field-label"><label for="field7">结束时间</label>:</div>
			            <div class="field-widget"><input class="easyui-datetimebox"  type="text" name="jobs.jcompany" id="field7" class="required" title="填写结束时间" /></div>
			        </div>
			        <div class="form-row">
			            <div class="field-label"><label for="field7">证明人</label>:</div>
			            <div class="field-widget"><input type="text" name="jobs.jpeople" id="field7" class="required" title="填写证明人" /></div>
			        </div>
			        <div class="form-row">
			            <div class="field-label"><label for="field7">证明人电话</label>:</div>
			            <div class="field-widget"><input type="text" name="jobs.jtel" id="field7" class="required" title="填写证明人电话" /></div>
			        </div>
            </fieldset>
        </div>
