		...
		<div style="padding:10px 60px 20px 60px">
			<form id="ff" method="post">
			  	<table cellpadding="5">
			  		<tr>
			  			<td>Coma:</td>
			  			<td><input class="easyui-textbox" name="computer.coma" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>Comb:</td>
			  			<td><input class="easyui-textbox" name="computer.comb" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>Stuid:</td>
			  			<td><input class="easyui-combobox" id="stuid" name="computer.student.intenid" data-options="required:true" /></input></td>
			  		</tr>
				</table>
		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				...
				<tr>
					<td>电脑部件</td>
					<td>
						<input class="easyui-textbox" name="computer.coma" id="ca" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>电脑整体</td>
					<td><input class="easyui-textbox" id="cb" name="computer.comb" data-options="required:true" /></input></td>
				</tr>
				<tr>
					<td>学生编码</td>
					<td><input class="easyui-combobox" id="si" name="computer.student.intenid" data-options="required:true" /></input></td>
				</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
