    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                <tr>
                    <td>谈心对象:</td>
                    <td><input class="easyui-textbox" name="says.sayface" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>策划人:</td>
                    <td><input class="easyui-textbox" name="says.sayempid" data-options="required:false"/></td>
                </tr>
                <tr>
                    <td>谈心内容:</td>
                    <td><input class="easyui-textbox" name="says.sayscon" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>谈心问题:</td>
                    <td><input class="easyui-textbox" name="says.sayspro" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>学生反馈:</td>
                    <td><input class="easyui-textbox" name="says.sysback" data-options="required:true"/></td>
                </tr>
            </table>
            <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
                ...
                <a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
                   onclick="close('addWindow')" style="width:80px">取消</a>
            </div>
        </form>
    </div>
</div>
        ...
        <form id="editForm">
            <table>
                ...
                <tr>
                    <td>策划人</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="sayempid" id="ssayempid"
                ...
                <tr>
                    <td>谈心内容</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="sayscon" id="ssayscon"
                               data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>谈心问题</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="sayspro" id="ssayspro"
                               data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>学生反馈</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="sysback" id="ssysback"
                               data-options="required:true"/><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
            </table>
            <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
                ...
                <a href="javascript:(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
                   onclick="close('editWindow')" style="width:80px">取消</a>
            </div>
        </form>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function edit() {
        if ($("#editForm").form("validate")) {
            ...
            $.get('says/update', {
                        'says.sayid': sayid,
                        'says.sayface': sayface,
                        'says.sayempid': sayempid,
                        'says.sayscon': sayscon,
                        'says.sayspro': sayspro,
                        'says.sysback': sysback
                    },
                    function (data) {
                        if (data.result.result == 'success') {
                            $.messager.alert("提示", data.result.msg, "info", function () {
