    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                <tr>
                    <td>研讨内容:</td>
                    <td><input class="easyui-textbox" name="dis.discom"
                               data-options="required:true,validType:'length[2,20]',novalidate:true"/></td>
                </tr>
                <tr>
                    <td>主讲教师:</td>
                    <td><input class="easyui-textbox" name="dis.empid"
                               data-options="required:true,validType:'length[1,10]',novalidate:true"/></td>
                </tr>
                <tr>
                    <td>研讨问题:</td>
                    <td><input class="easyui-textbox" name="dis.dispro"
                               data-options="required:true,validType:'length[5,10]',novalidate:true"/></td>
                </tr>
                <tr>
                    <td>解决方案:</td>
                    <td><input class="easyui-textbox" name="dis.diskey"
                               data-options="required:true,validType:'length[10,20]',novalidate:true"/></td>
                </tr>
            </table>
        ...
        <form id="editForm">
            <table>
                <tr>
                    <td>研讨内容:</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="discom" id="editDiscom"
                ...
                <tr>
                    <td>主讲教师:</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="empid" id="editEmpid"
                ...
                <tr>
                    <td>研讨问题:</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="dispro" id="editDispro"
                               data-options="required:true,validType:'length[1,10]',novalidate:true"/>
                        <!-- 由dataoptions指定验证的规则 --><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>解决方案:</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="diskey" id="editDiskey"
                               data-options="required:true,validType:'length[1,30]',novalidate:true"/>
                        <!-- 由dataoptions指定验证的规则 --><!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
            </table>
