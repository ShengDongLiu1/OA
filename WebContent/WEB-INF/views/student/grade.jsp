			...
			<form id="addfrom">
				<table>
					...
					<tr>
						...
						<td>
							<input id="xiala" class="easyui-combobox" style="width:100%;height:32px" data-options="required:true,validType:'length[1,10]',novalidate:true" name="sconame" />
						</td>
					</tr>
					<tr>
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<input id="en" class="easyui-combobox" style="width:100%;height:32px" data-options="required:true,validType:'length[1,10]',novalidate:true" name="sconame" />
						</td>
					</tr>
					<tr>
						<td><span style="width:100%;height:32px">分&nbsp;数&nbsp;</span></td>
