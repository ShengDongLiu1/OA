...
<table id="list" class="easyui-datagrid" toolbar="#tb" data-options="
    ...
    <thead>
    <tr>
        <th data-options="field:'objectid',checkbox:true,width:100">编号</th>
        <th data-options="field:'objectname',width:100">课程名称</th>
    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                <tr>
                    <td>课程:</td>
                    <td><input class="easyui-textbox" id="objectname" name="course.objectname"
                               data-options="required:true"></td>
                </tr>
                <tr>
                    <td>学期:</td>
                    <td><input class="easyui-textbox" id="semester" name="course.semester" data-options="required:true">
                    </td>
                </tr>
            </table>
        ...
        <form id="editForm">
            <table>
                <tr>
                    <td>编号:</td>
                    <td>
                        <input class="easyui-textbox" id="oid" name="objectid" data-options="required:true" readonly>
                    </td>
                </tr>
                <tr>
                    <td>课程:</td>
                    <td><input class="easyui-textbox" id="oname" name="objectname" data-options="required:true"></td>
                </tr>
                <tr>
                    <td>学期:</td>
                    <td><input class="easyui-textbox" id="ster" name="semester" data-options="required:true"></td>
                </tr>
            </table>
            <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
...
<script type="text/javascript">
    ...
    function add() {
        if ($("#ff").form("validate")) {
            $.get('course/add', $("#ff").serialize(), "JSON");
            $("#ff").form("clear");
    ...
    function edit() {
        ...
        if ($("#editForm").form("validate")) {
            var objectid = $("#oid").val();
            var objectname = $("#oname").val();
            var semester = $("#ster").val();
            $.get('course/update', {
                'course.objectid': objectid,
                'course.objectname': objectname,
