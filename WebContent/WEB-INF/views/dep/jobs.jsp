...
<div id="p2" class="easyui-navpanel">
    <div id="content" class="easyui-panel" style="width:811px;height:630px;"
        ...
        <header>
            <div class="m-toolbar">
                <div class="m-left" style="margin-left: 60px;">
                    <a href="<%=path %>/dep/all" class="easyui-linkbutton m-back"
        ...
        <div style="padding:10px;margin-left: 50px;margin-top: 50px; ">
            ...
            <br/><br/>
            <div class="zl"><h3>公司名称:</h3></div>
            <div class="textS"><s:property value="jobs.jstart"/></div>
            <br/><br/>
            <div class="zl"><h3>公司职位:</h3></div>
...
<div id="editWin" class="easyui-window" title="修改员工工作信息" data-options="iconCls:'icon-edit', closable:true, closed:true"
    ...
    <form id="editForm" enctype="multipart/form-data">
        ...
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>公司名称:</div>
            <br/>
            <input class="easyui-textbox" id="gsmc" data-options="required:true" name="jobs.jstart"
                   style="width:300px;height:25px">
        </div>
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>公司职位:</div>
            <br/>
            <input class="easyui-textbox" id="gszw" data-options="required:true" name="jobs.jedu"
                   style="width:300px;height:25px">
        </div>
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>开始时间:</div>
            <br/>
            <input class="easyui-datetimebox" id="kssj" data-options="required:true" name="jobs.jend"
                   style="width:300px;height:25px">
        </div>
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>结束时间:</div>
            <br/>
            <input class="easyui-datetimebox" id="jssj" data-options="required:true" name="jobs.jcompany"
                   style="width:300px;height:25px">
        </div>
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>证明人:</div>
        ...
        <div style="margin-bottom:20px;margin-left: 40px;margin-top: 10px;">
            <div>证明人电话:</div>
            <br/>
            <input class="easyui-textbox" id="zmrdh" data-options="required:true" name="jobs.jtel"
                   style="width:300px;height:25px">
        </div>
        <div style="margin-left: 170px;float: left;">
            <a href="javascript:;" onclick="closeEdit();" class="easyui-linkbutton" data-options="iconCls:'icon-remove'"
               style="height:32px;float: left;">取消修改</a>
        </div>
        <div style="margin-left: 20px;float: left;">
            <a href="javascript:;" onclick="doEdit();" class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
               style="height:32px;">确认修改</a>
        </div>
    </form>
</div>
</body>
