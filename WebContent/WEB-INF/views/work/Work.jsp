			...
			<form id="ff" method="post">
			  	<table>
			  		<tr>
						<td>Wtypeid:</td>
						<td>
							<input class="easyui-combobox" id="wtypeid" name="work.worktype.swid" data-options="required:true" /></input>
						</td>
					</tr>
			  		<tr>
			  			<td>Wname:</td>
			  			<td><input class="easyui-textbox" id="wname" name="work.wname" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>Wamount:</td>
			  			<td><input class="easyui-textbox" id="wamount" name="work.wamount" data-options="required:true" /></input></td>
			  		</tr>
				</table>
		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				<tr>
					<td>编号</td>
					<td>
						<input class="easyui-textbox" name="work.wid" id="wi" readonly />
					</td>
				</tr>
				<tr>
					<td>类型</td>
					<td>
						<input class="easyui-combobox" name="work.worktype.swid" id="wt" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>名称</td>
					<td><input class="easyui-textbox" id="wn" name="work.wname" data-options="required:true" /></input></td>
				</tr>
				<tr>
					<td>数量</td>
					<td>
						<input class="easyui-textbox" name="work.wamount" id="wa" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
