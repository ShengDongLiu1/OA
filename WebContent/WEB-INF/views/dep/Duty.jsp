		...
		<div style="padding:10px 60px 20px 60px">
			<form id="ff" method="post">
			  	<table cellpadding="5">
					<tr>
			  			<td>员工编号:</td>
			  			<td><input class="easyui-textbox" id="eid" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>值班时间:</td>
			  			<td><input class="easyui-textbox" id="ddatetime" data-options="required:false" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>值班范围:</td>
			  			<td><input class="easyui-textbox" id="drange" data-options="required:true" /></input></td>
			  		</tr>
			  		<tr>
			  			<td>情况记录:</td>
			  			<td><input class="easyui-textbox" id="ddesc" data-options="required:true" /></input></td>
			  		</tr>
				</table>
		...
		<div style="padding:10px 60px 20px 60px">
			...
			<table>
				<tr>
					<td>值班管理编号</td>
					<td>
						<input class="textbox" name="did" id="ddid" readonly />
					</td>
				</tr>
				<tr>
					<td>员工编号</td>
					<td>
						<input class="easyui-validatebox textbox" name="eid" id="dutyeid" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>值班时间</td>
					<td>
						<input class="easyui-validatebox textbox" name="ddatetime" id="dutyddatetime" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>值班范围</td>
					<td>
						<input class="easyui-validatebox textbox" name="drange" id="dutydrange" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
				<tr>
					<td>情况记录</td>
					<td>
						<input class="easyui-validatebox textbox" name="ddesc" id="dutyddesc" data-options="required:true" /><!-- 由dataoptions指定验证的规则 -->
					</td>
				</tr>
			</table>
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
	...
	<script type="text/javascript">
		...
		function add(){
			if($("#ff").form("validate")){
				...
				var ddesc = $("#ddesc").val();
				$.get('duty/add',{'duty.eid':eid,'duty.ddatetime':ddatetime,'duty.drange':drange,'duty.ddesc':ddesc},
					function(data) {
		...
		function edit(){
			if($("#editForm").form("validate")){
				...
				$.get('duty/update',{'duty.did':did,'duty.eid':eid,'duty.ddatetime':ddatetime,'duty.drange':drange,'duty.ddesc':ddesc},
					function(data) {
					if (data.result.result == 'success') {
						$.messager.alert("提示", data.result.msg, "info", function() {
