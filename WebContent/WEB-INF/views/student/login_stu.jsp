...
<body onload="init()">
    ...
    <fieldset>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" id="field1" name="studentyx.intenname" class="required" title="Enter your name" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">民族</label>:</div>
            <div class="field-widget"><input type="text" id="field2" name="studentyx.intenmz" class="required" title="Enter your name" /></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" id="field3" name="studentyx.intenjg" class="required" title="Enter your name" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field4">毕业学校</label>:</div>
            <div class="field-widget"><input type="text" id="field4" name="studentyx.intensch" class="required" title="Enter your name" /></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" id="field5" name="studentyx.intenage" class="required" title="Enter your name" /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field6">家长姓名</label>:</div>
            <div class="field-widget"><input type="text" id="field6" name="studentyx.intenfat" class="required" title="Enter your name" /></div>
        </div> 
        
        <div class="form-row">
            <div class="field-label"><label>出生年月</label>:</div>
            <div class="field-widget">
                <select id="year" name="year"></select>年 <select id="month" name="month" onchange="changeDay()"></select>月<select name="day" id="day"></select>日
            </div>
        </div>
           
        <div class="form-row">
            <div class="field-label"><label for="field7">学生电话</label>:</div>
            <div class="field-widget"><input type="text" name="studentyx.intentel" id="field7" class="required" title="Enter a password greater than 6 characters" /></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget">
                <input type="text" name="studentyx.intenfatel" id="field8" class="required" title="Enter your name" />		
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><textarea id="field10" name="studentyx.intenpeo" class="required"></textarea></div>
        </div>
