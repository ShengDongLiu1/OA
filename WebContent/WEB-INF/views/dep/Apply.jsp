    ...
    <div style="padding: 10px 60px 20px 60px">
        <form id="ff" method="post">
            <table>
                <tr>
                    <td>员工姓名:</td>
                    <td><input class="easyui-combobox" id="eid" name="apply.dep.eid" name="apply.eid"
                ...
                <tr>
                    <td>物品类型:</td>
                    <td><input class="easyui-combobox" id="wid" name="apply.worktype.swid" name="apply.wid"
                               data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>物品数量:</td>
        ...
        <form id="editForm">
            ...
            <table>
                ...
                <tr>
                    <td>物品名称</td>
                    <td>
                        <input class="easyui-textbox" name="apply.goodsname" id="gn" data-options="required:true"/>
                        <!-- 由dataoptions指定验证的规则 -->
                    </td>
                </tr>
                <tr>
                    <td>物品类型:</td>
                    <td><input class="easyui-combobox" id="wi" name="apply.worktype.swid" data-options="required:true"/>
                    </td>
                </tr>
                <tr>
                    <td>物品数量</td>
                    <td><input class="easyui-textbox" id="gs" name="apply.gcounts" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>单位</td>
                    <td><input class="easyui-textbox" id="gt" name="apply.gunit" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>物品单价</td>
                    <td><input class="easyui-textbox" id="gp" name="apply.gprice" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>物品用途</td>
                    <td><input class="easyui-textbox" id="gpe" name="apply.gpurpose" data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>申请时间:</td>
                    <td><input class="easyui-datetimebox" id="dt" value="apply.adatetime" name="apply.adatetime"
                               data-options="required:true"/></td>
                </tr>
            </table>
...
<script type="text/javascript">
    ...
    function updateSP() {
        ...
        $.post('apply/updateSP', {
                    'apply.aid': row.aid,
                    'apply.astatus': row.astatus,
                    "apply.gprice": roe.gprice,
                    "apply.gcounts": row.gcounts
                },
                function (data) {
                    if (data.result.result == 'success') {
                        $.messager.alert("提示", data.result.msg, "info", function () {
