	...
	<div id="tb" style="padding: 5px;" >
		...
		<div style="float: left;">
			<form action="<%=path%>/dep/byname" method="post" style="float:inherit;">
				<input style="height: 20px;" id="ename" name="dep.ename" placeholder="根据姓名查询" /></input>
		...
		<form id="editForm" enctype="multipart/form-data">
			<table style="margin: auto">
				<tr>
		  		...
		  		<tr>
					<td>员工生日:</td>
					<td><input class="easyui-datebox" value="10/11/2012" id="ebirth" name="dep.ebirth" style="width:200px"></td>
				</tr>
		  		<tr>
		  			<td>身份证号:</td>
		  		...
		  		<tr>
		  			<td>员工状态:</td>
		  			<td><input class="easyui-textbox" id="estatus" name="dep.estatus" data-options="required:true" /></input></td>
		  		</tr>
				<tr >
		...
		<form id="addForm" enctype="multipart/form-data">
			<table>
				<tr>
		  		...
		  		<tr>
		  			<td><br/>员工状态:</td>
		  			<td><br/><input class="easyui-textbox"  name="dep.estatus" data-options="required:true" /></input></td>
		  		</tr>
			</table>
