    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table cellpadding="5">
                <tr>
                    <td>Swname:</td>
                    <td><input class="easyui-textbox" id="swname" data-options="required:true"/></td>
                </tr>
            </table>
        ...
        <form id="editForm">
            <table>
                <tr>
                    <td>编号</td>
                    <td>
                        <input class="textbox" name="swid" id="editSwid" readonly/>
                    </td>
                </tr>
                <tr>
                    <td>类型</td>
                    <td>
                        <input class="easyui-validatebox textbox" name="swname" id="editSwname"
...
<script type="text/javascript">
    ...
    function add() {
        if ($("#ff").form("validate")) {
            ...
            $.get('worktype/add', {'worktype.swname': swname},
                    function (data) {
    ...
    function edit() {
        if ($("#editForm").form("validate")) {
            var swid = $("#editSwid").val();
            var swname = $("#editSwname").val();
            $.get('worktype/update', {'worktype.swid': swid, 'worktype.swname': swname},
                    function (data) {
                        if (data.result.result == 'success') {
                            $.messager.alert("提示", data.result.msg, "info", function () {
